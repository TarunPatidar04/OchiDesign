...
const Footer = () => {
  return (
    <div className="w-full h-screen bg-zinc-900 p-20 flex gap-5">
      <div className="w-1/2 h-full flex flex-col justify-between tracking-tighter font-['Founders_Grotesk_X-Condensed'] font-medium">
        <div className="heading">
          <h1 className="text-[7vw] uppercase leading-none -mb-5  font-semibold">
            Eye-
          </h1>
          <h1 className="text-[7vw] uppercase leading-none -mb-10 font-semibold">
            Opening
          </h1>
        </div>
        <svg
      ...
      <div className="w-1/2">
        <h1 className="text-[6vw]  uppercase leading-none  tracking-tighter font-['Founders_Grotesk_X-Condensed'] font-medium">
          Presentations
        </h1>
        <div className="dets font-['Neue_montreal'] mt-10">
          <a href="" className="block textxl font-light">
            Facebook
          </a>
          <a href="" className="block textxl font-light">
            Instagram
